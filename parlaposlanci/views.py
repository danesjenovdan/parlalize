    ...
    out = {
        ...
        'results': {
            'abstain': {
                ...
                'maxCoalition': {
                    'mps': [getPersonData(person.id_parladata, date) for person in Person.objects.filter(id_parladata__in=[int(textid) for textid in cutVotes.coalition_abstain_max_person.split(',')])],
                    'score': cutVotes.coalition_abstain_max
                },
                'maxOpposition': {
                    'mps': [getPersonData(person.id_parladata, date) for person in Person.objects.filter(id_parladata__in=[int(textid) for textid in cutVotes.opposition_abstain_max_person.split(',')])],
            ...
            "against": {
                ...
                'maxCoalition': {
                    'mps': [getPersonData(person.id_parladata, date) for person in Person.objects.filter(id_parladata__in=[int(textid) for textid in cutVotes.coalition_against_max_person.split(',')])],
                    'score': cutVotes.coalition_against_max
                },
                'maxOpposition': {
                    'mps': [getPersonData(person.id_parladata, date) for person in Person.objects.filter(id_parladata__in=[int(textid) for textid in cutVotes.opposition_against_max_person.split(',')])],
            ...
            "absent": {
                ...
                'maxCoalition': {
                    'mps': [getPersonData(person.id_parladata, date) for person in Person.objects.filter(id_parladata__in=[int(textid) for textid in cutVotes.coalition_absent_max_person.split(',')])],
                    'score': cutVotes.coalition_absent_max
                },
                'maxOpposition': {
                    'mps': [getPersonData(person.id_parladata, date) for person in Person.objects.filter(id_parladata__in=[int(textid) for textid in cutVotes.opposition_absent_max_person.split(',')])],
            ...
            'for': {
                ...
                'maxCoalition': {
                    'mps': [getPersonData(person.id_parladata, date) for person in Person.objects.filter(id_parladata__in=[int(textid) for textid in cutVotes.coalition_for_max_person.split(',')])],
                    'score': cutVotes.coalition_for_max
                },
                'maxOpposition': {
                    'mps': [getPersonData(person.id_parladata, date) for person in Person.objects.filter(id_parladata__in=[int(textid) for textid in cutVotes.opposition_for_max_person.split(',')])],
